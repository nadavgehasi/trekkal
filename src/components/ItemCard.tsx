...
const ItemCard: React.FC<{item: Item, updateItem: (updatedItem: Item) => void}> = ({item, updateItem}) => {
    ...
    return (
        <View>
          ...
          <EditItemModal isVisible={editItemVisible} currentItem={item} updateItem={update} onClose={()=> {setEditItemVisible(false)}}/>
        </View>
    )
}
